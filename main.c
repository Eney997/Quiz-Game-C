...
int main()
{
        ...
        if(i == 7){
            ...
            printf("3) First computer virus know as?\n\n");
            printf("1) Rabbit\n");
            ...
            printf("5)Which of the following is not a database managment software?\n\n");
            printf("1) Mysql\n");
            printf("2) Oracle\n");
            printf("3) Cobal\n");
            printf("4) Sybase\n\n");
            ...
            if(ans5 == 3){
                printf("Correct Answer\n");
                point5 = 5;
                printf("You have score %d point:",point5);
            }else {
                printf("Wrong Answer\n");
                point05 = 0;
                printf("You have scored %d point:",point05);
            }
        }
